...
function bethel_do_home_page() {
	...
	echo '<img style="display:none" class="home-main-a" src="'.get_stylesheet_directory_uri().'/images/everyone-welcome.jpg" height="615" width="1140"/>';
	echo '<img style="display:none" class="home-main-b" src="'.get_stylesheet_directory_uri().'/images/something-for-everyone.jpg" height="615" width="1140"/>';
	echo '<img style="display:none" class="home-main-c" src="'.get_stylesheet_directory_uri().'/images/ordinary-people.jpg" height="615" width="1140"/>';
}
